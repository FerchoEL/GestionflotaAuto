...
class VehiculoResponsableResource extends Resource
{
    ...
    {
        return auth()->user()?->can('vehiculo-responsable.view') ?? false;
    }
    ...
    {
        return auth()->user()?->can('vehiculo-responsable.create') ?? false;
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()?->can('vehiculo-responsable.update') ?? false;
    }
