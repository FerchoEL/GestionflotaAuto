...
class VehiculoLocalidadResource extends Resource
{
    ...
    {
        return auth()->user()?->can('vehiculo-localidad.view') ?? false;
    }
    ...
    {
        return auth()->user()?->can('vehiculo-localidad.create') ?? false;
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()?->can('vehiculo-localidad.update') ?? false;
    }
